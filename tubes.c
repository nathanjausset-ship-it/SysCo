...
{
   printk_debug(DBG_KERNEL_TUBE, "in ouvrir\n");
   ...
   printk_debug(DBG_KERNEL_TUBE, "out ouvrir\n");
...
int tubeFermer(Fichier * f)
{
   ...
   printk_debug(DBG_KERNEL_TUBE, "out fermer\n");
...
size_t tubeLire(Fichier * f, void * buffer, size_t nbOctets)
{
   ...
   printk_debug(DBG_KERNEL_TUBE, "in lire\n");
